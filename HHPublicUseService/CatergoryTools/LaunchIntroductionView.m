...
- (void)addTipBtn{
    ...
    UIButton *enterButton = [[UIButton alloc] initWithFrame:CGRectMake(SCREEN_WIDTH-20-30, StatusBarHeight+10, 30, 21)];
    [enterButton setTitle:@"跳过" forState:UIControlStateNormal];
    [enterButton setTitleColor:HexString(@"FFB132") forState:UIControlStateNormal];
    enterButton.titleLabel.font = [UIFont fontWithName:@"PingFangSC-Semibold" size:15];
...
-(void)createScrollView{
    ...
    page = [[DZPageControl alloc] initWithFrame:CGRectMake(0, kScreen_height - 50, kScreen_width, 30)];
    page.pageSide = 8;
    page.pageHeight = 4;
    page.pageWidth = 12;
