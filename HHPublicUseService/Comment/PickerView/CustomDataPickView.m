...
-(void)initYesArr {
    ...
    NSString *maxYearStr = [NSDate stringFromDate:self.maximumDate DateFormat:@"yyyy"];
    NSString *minYearStr = [NSDate stringFromDate:self.minimumDate DateFormat:@"yyyy"];
...
-(void)initMonthArr {
    ...
    NSString *maxMonthStr = [NSDate stringFromDate:self.maximumDate DateFormat:@"MM"];
    NSString *maxYearStr = [NSDate stringFromDate:self.maximumDate DateFormat:@"yyyy"];
    
    NSString *minMonthStr = [NSDate stringFromDate:self.minimumDate DateFormat:@"MM"];
    NSString *minYearStr = [NSDate stringFromDate:self.minimumDate DateFormat:@"yyyy"];
...
-(void)YearMonthEqual_pickerView:(UIPickerView *)pickerView inComponent:(NSInteger)component month:(int)month Year:(int) year {
    NSString *maxYearStr = [NSDate stringFromDate:self.maximumDate DateFormat:@"yyyy"];
    NSString *maxMonthStr = [NSDate stringFromDate:self.maximumDate DateFormat:@"MM"];
    NSString *maxDayStr = [NSDate stringFromDate:self.maximumDate DateFormat:@"dd"];
...
-(void)calculateDayWithMonth:(int) month andYear:(int) year{
    ...
    NSString *minYearStr = [NSDate stringFromDate:self.minimumDate DateFormat:@"yyyy"];
    NSString *minMonthStr = [NSDate stringFromDate:self.minimumDate DateFormat:@"MM"];
    NSString *minDayStr = [NSDate stringFromDate:self.minimumDate DateFormat:@"dd"];
...
- (void)show{
    self.month = [NSDate stringFromDate:self.defaultSelectDate DateFormat:@"M"];
    self.year = [NSDate stringFromDate:self.defaultSelectDate DateFormat:@"y"];
    ...
    NSString *defaultYearStr = [NSDate stringFromDate:self.defaultSelectDate DateFormat:@"y"];
    NSUInteger yeasRow = [self.yearArray indexOfObject:defaultYearStr];
    
    NSString *defaultMonthStr = [NSDate stringFromDate:self.defaultSelectDate DateFormat:@"M"];
    NSUInteger monthRow = [self.monthArray indexOfObject:defaultMonthStr];
    
    NSString *defaultDayStr = [NSDate stringFromDate:self.defaultSelectDate DateFormat:@"d"];
